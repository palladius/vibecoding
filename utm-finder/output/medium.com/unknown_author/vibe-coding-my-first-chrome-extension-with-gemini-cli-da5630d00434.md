...
**Report for Article: `vibe-coding-my-first-chrome-extension-with-gemini-cli-da5630d00434.md`**
...
* `https://github.com/google-gemini/gemini-cli` 3x
* `https://github.com/google-gemini/gemini-cli/` 3x
* `http://gemini.md` 3x
* `https://medium.com/google-cloud?source=post_page---post_publication_info--da5630d00434---------------------------------------` 3x
...
* `https://github.com/palladius/vibecoding/blob/main/GEMINI.md`
* `https://www.searchapi.io/`
* `https://serpapi.com/`
* `https://github.com/GoogleCloudPlatform/cloud-run-mcp`
* `https://rails8-turbo-chat-dev-272932496670.europe-west10.run.app/`
